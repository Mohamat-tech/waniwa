...
function App() {
  ...
  return (
    <div className={styles.app} dir={isRtl ? 'rtl' : 'ltr'}>
      <Header t={t} activeSection={activeSection} onSectionChange={handleSectionChange} language={language} onLanguageChange={setLanguage} theme={theme} onToggleTheme={() => setTheme(theme === 'dark' ? 'light' : 'dark')} onOpenCollector={() => setShowCollector(true)} />
